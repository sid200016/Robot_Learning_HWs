...
\newpagestyle{ruled}
{\sethead{CMU 16-831}{Intro to Robot Learning}{Spring 2026}\headrule
  \setfoot{}{}{}}
\pagestyle{ruled}
...
\begin{figure*}[!h]
	\centering
\includegraphics[width=0.5\columnwidth]{path/to/your/image.png}
...
\begin{figure*}[!h]
	\centering
	\includegraphics[width=1.0\columnwidth]{path/to/your/image.png}
