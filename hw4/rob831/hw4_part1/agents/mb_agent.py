...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            observations = ob_no[i*self.ensemble_size:i*self.ensemble_size + num_data_per_ens + 1]
            actions = ac_na[i*self.ensemble_size:i*self.ensemble_size + num_data_per_ens + 1]
            next_observations = next_ob_no[i*self.ensemble_size:i*self.ensemble_size + num_data_per_ens + 1]
